...
import com.example.zuulsvr.model.AbTestingRoute;
...
public class SpecialRoutesFilter extends ZuulFilter{
    ...
    private String buildRouteString(String oldEnpoint, String newEndpoint, String serviceName) {
        int index = oldEnpoint.indexOf(serviceName);

        String strippedRoute = oldEnpoint.substring(index + serviceName.length());
        System.out.println("Target route: " + String.format("{}/{}", newEndpoint, strippedRoute));
        return String.format("{}/{}", newEndpoint, strippedRoute);
    }
